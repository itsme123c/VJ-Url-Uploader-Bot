...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "8082116482:AAG7ZElvFRNfWeDK6KEIudSOav-ngiBNO0o")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "Mybot_budbot") # Bot username without @.
    ...
    TECH_VJ_SESSION_NAME = "Tg-URL-UPLOADER-BOT"
    
    # database uri (mongodb)
    TECH_VJ_DATABASE_URL = os.environ.get("TECH_VJ_DATABASE_URL", "mongodb+srv://python21java:<8ZFGYMKJCqAPwsiO>@cluster0.4ieuy.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
    ...
    TECH_VJ_URL = environ.get('TECH_VJ_URL', 'Earn4link.in') # your shortlink url domain or url without https://
    TECH_VJ_API = environ.get('TECH_VJ_API', '0e60b70d80e20f7bfc1fd4e75138b8853458da5a') # your url shortner api
